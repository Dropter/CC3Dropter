...
static uint32_t gcstelemetrystats_objid = GCSTELEMETRYSTATS_OBJ_ID;
...
void uavtalk_send_msg(uavtalk_message_t *msg) {
   ...
   int uavtalk_read(uavtalk_message_t *msg) {
   	...
   	switch (msg->ObjID) {
             case FLIGHTTELEMETRYSTATS_OBJ_ID:
   	  ...
   	  case ATTITUDESTATE_OBJ_ID:
               last_flighttelemetry_connect = millis();
               show_prio_info = 1;

               dt_roll = (int16_t) uavtalk_get_float(msg, ATTITUDESTATE_ROLL);
               dt_pitch = (int16_t) uavtalk_get_float(msg, ATTITUDESTATE_PITCH);
               dt_yaw = (int16_t) uavtalk_get_float(msg, ATTITUDESTATE_YAW);
               break;
            }
